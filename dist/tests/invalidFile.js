...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, lib_1.default)({ title: 'EPub Gen', verbose: true }, [{ content: "<p>Generate EPUB books from HTML with a simple API in Node.js or the browser.</p><p><img src=\"file:///invalid/file/path\">" }])];
            case 1:
                _a.sent();
                process.exit(-1);
                return [3 /*break*/, 3];
