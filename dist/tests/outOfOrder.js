...
var warnings = [];
aliceData_1.optionsAlice.verbose = function (type) {
    var args = [];
    ...
    if (type === 'warn')
        warnings.push(args);
    (type === 'warn' ? console.warn : console.log).apply(void 0, args);
};
aliceData_1.contentAlice[2].beforeToc = true;
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var content, order, content2, order2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (!order)
                    process.exit(-1);
                aliceData_1.contentAlice[1].beforeToc = true;
                warnings.splice(0);
