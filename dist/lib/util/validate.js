...
var filenameReq = ow_1.default.string.is(function (s) { return (s.indexOf('/') === -1 && s.indexOf('\\') === -1) || "Filename must not include slashes, got `".concat(s, "`"); });
...
exports.optionsPredicate = ow_1.default.object.partialShape({
    ...
    version: ow_1.default.optional.number.is(function (x) { return x === 3 || x === 2 ||
        "Expected version to be 3 or 2, got `".concat(x, "`"); }),
